    ...
    async fn run_chunk_loop(
        ...
        loop {
            ...
            while !generation_done && join.len() < k {
                ...
                crate::jobs::combo_metadata::write_combo_metadata_table_raw_offset(
                    &self.repo,
                    &self.job_id,
                    &chunk.metadata,
                    &chunk.profileset_lines,
...
/// [`crate::jobs::finalize::finalize_gear_comparison_result`] but consumes
/// pre-merged JSON. No
...
pub async fn finalize_cloud_result(
    ...
    let raw_meta = crate::jobs::combo_metadata::load_combo_metadata(repo, job_id).await;
